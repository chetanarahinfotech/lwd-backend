...
import com.lwd.jobportal.jobapplication.JobApplicationResponse;
import com.lwd.jobportal.jobapplication.PagedApplicationsResponse;
...
public class RecruiterService {
    ...
    public void requestCompanyApproval(Long companyId) {
        ...
        recruiter.setStatus(UserStatus.COMPANY_PENDING_APPROVAL);
