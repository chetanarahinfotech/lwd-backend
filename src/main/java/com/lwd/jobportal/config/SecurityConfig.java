...
import com.lwd.jobportal.security.JwtFilter;
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/company-admin/**").hasAnyRole("ADMIN", "COMPANY_ADMIN")
                .requestMatchers("/api/recruiter/**").hasAnyRole("ADMIN", "COMPANY_ADMIN", "RECRUITER")
                ...
                .requestMatchers("/api/dashboard/**").hasAnyRole("ADMIN", "COMPANY_ADMIN", "RECRUITER")
...
//                .requestMatchers("/actuator/metrics/**").hasRole("ADMIN")
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of(
            "http://localhost:5173",
            "https://lwd-jobseekers.netlify.app"
        ));
