...
public class MessagingService {
    ...
    public ChatMessageResponseDto sendMessage(Long senderId, SendMessageDto request) {
        ...
        boolean isSenderRecruiter = sender.getRole() == Role.RECRUITER || sender.getRole() == Role.COMPANY_ADMIN;
        boolean isSenderSeeker = sender.getRole() == Role.JOB_SEEKER;
        boolean isRecipientRecruiter = recipient.getRole() == Role.RECRUITER || recipient.getRole() == Role.COMPANY_ADMIN;
        ...
        // ✅ push live unread count to recipient
        sendUnreadMessageCount(request.getRecipientId());
    ...
    public void markConversationAsRead(Long userId, Long conversationId) {
        ...
        if (latestMessageId != null) {
            ...
            // ✅ push updated unread count to current user
   ...
   private void validateMessagingAllowed(User sender, User recipient) {
	    boolean isSenderRecruiter =
	            sender.getRole() == Role.RECRUITER || sender.getRole() == Role.COMPANY_ADMIN;
	    boolean isSenderSeeker = sender.getRole() == Role.JOB_SEEKER;

	    boolean isRecipientRecruiter =
	            recipient.getRole() == Role.RECRUITER || recipient.getRole() == Role.COMPANY_ADMIN;
	    boolean isRecipientSeeker = recipient.getRole() == Role.JOB_SEEKER;
   ...
   private void sendUnreadMessageCount(Long userId) {
