...
public class CompanyController {
    ...
    @Operation(
            ...
            description = "Create a new company profile. Accessible to ADMIN and COMPANY_ADMIN only."
    )
    @ApiResponses(value = {
    ...
    @Operation(
            ...
            description = "Fetch company details by created-by user ID. Accessible to ADMIN and COMPANY_ADMIN only."
    )
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Company fetched successfully"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    @Operation(
            ...
            description = "Update company profile by company ID. Accessible to ADMIN and COMPANY_ADMIN only."
    )
    @ApiResponses(value = {
    ...
    @Operation(
            ...
            description = "Soft delete company by company ID. Accessible to ADMIN and COMPANY_ADMIN only."
    )
    @ApiResponses(value = {
